                ...
                <div class="scrollable-table">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <th class="sticky-header" style="background-color: white">Email</th>
                            <th class="sticky-header" style="background-color: white">Navn</th>
                        </tr>
                ...
                <div class="scrollable-table">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <th class="sticky-header" style="background-color: white">Oprettelses dato</th>
                            <th class="sticky-header" style="background-color: white">Status</th>
                            <th class="sticky-header" style="background-color: white">Kunde</th>
                        </tr>
